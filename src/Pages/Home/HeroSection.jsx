  ...
  return (
    <section id="heroSection" className="hero--section">
      <div className="hero--section--content--box">
        <div className="hero--section--content">
          ...
          <h1 className="hero--section--title">
            <span className="hero--section-title--color">Zain</span>{" "}
            <br />
            Keshwani
          </h1>
          <p className="hero--section-description">
            Welcome to my site—
            <br /> made to present a little about myself.
          </p>
          <div className="footer--social--icon--hero">
          <ul>
            <li>
              <a
      ...
      <div className="hero--section--img">
        <img src="./img/selfimage2.jpg" alt="Hero Section" />
      </div>
    </section>
  );
}
