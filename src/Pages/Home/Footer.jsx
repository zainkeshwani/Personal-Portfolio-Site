  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <p className='navbar-name'>Zain Keshwani</p>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/zainkeshwani/"
            ...
            <li>
              <a
                href="https://github.com/zainkeshwani/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
                ...
                >
                  ...
                  -3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82a7.6
                  7.6 0 012.01-.27c.68 0 1.36.09 2.01.27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/zain-keshwani"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
